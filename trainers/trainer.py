...
if __name__ == "__main__":
    ...
    exp_dir = "experiments/scratch"
    trainer = Trainer(train_loader, val_loader, model, loss_fn, optimizer, patience=3, exp_dir=exp_dir)

    # Train the model
    trainer.train(epochs=5, eval_every=1, resume=True)